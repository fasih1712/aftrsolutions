...
export const steps = [
  ...
  { n: '02', title: 'Design', text: 'A clear architecture and roadmap, scoped, estimated and agreed before we build anything.' },
  { n: '03', title: 'Build', text: 'Short iterations, working software early, and full visibility at every stage.' },
  { n: '04', title: 'Run', text: 'We deploy, monitor and keep improving it, so it keeps working long after launch.' },
]
...
export const useCases = [
  ...
  { title: 'Hands-free lead follow-up', text: 'New enquiries are qualified, logged in your CRM and followed up automatically, so nothing slips through.', service: 'ai-automation-agents' },
  { title: 'A move to the cloud', text: 'Migrate servers and apps to AWS, Azure or Alibaba Cloud, onto Docker and Kubernetes, with a clear plan, no surprises and lower running costs.', service: 'devops-cloud' },
  ...
  { title: 'ERP that fits your business', text: 'Finance, inventory, sales and operations in one system, set up around the way you actually work.', service: 'development' },
  ...
  { title: 'IT that just works', text: 'Servers, Microsoft 365, identity and backups managed and monitored, so your team can focus on its own work.', service: 'managed-infrastructure' },
]
