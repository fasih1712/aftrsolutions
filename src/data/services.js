...
export const services = [
  {
    ...
    faqs: [
      ...
      { q: 'How long does a first agent take to launch?', a: 'A focused first agent typically goes live in 2–4 weeks, followed by iterative improvements based on real usage.' },
    ],
  },
  {
    slug: 'devops-cloud',
    ...
    intro:
      'From your first cloud migration to fully automated delivery pipelines, we build infrastructure that is secure, observable and cost-efficient. We work across AWS, Azure, Alibaba Cloud and GCP, and treat everything as code so it can be reviewed, repeated and recovered.',
    offerings: [
      ...
      { title: 'Containers & Kubernetes', text: 'Dockerised applications running on Kubernetes (EKS, AKS, ACK) or lean Docker hosts — right-sized to your needs.' },
      { title: 'Infrastructure as Code', text: 'Terraform and Ansible for reproducible environments, reviewed like any other code.' },
      { title: 'Monitoring & observability', text: 'Metrics, logs and alerts with Prometheus, Grafana and cloud-native tooling — know before your users do.' },
    ...
    stack: ['AWS', 'Azure', 'Alibaba Cloud', 'GCP', 'Kubernetes', 'Docker', 'Terraform', 'GitHub Actions', 'Prometheus', 'Grafana'],
    outcomes: [
    ...
    faqs: [
      { q: 'Which cloud provider should we choose?', a: 'It depends on your workloads, region, existing licences and budget. We hold certifications across providers and will recommend what fits — not what we prefer.' },
  ...
  },
  {
    ...
    faqs: [
      { q: 'How long does a website take?', a: 'A business website usually takes 2–4 weeks. Web and mobile apps depend on scope — we give a clear estimate after the discovery call.' },
      { q: 'Will we own the code?', a: 'Yes. You get full ownership of the code, designs and infrastructure accounts.' },
      { q: 'Do you provide support after launch?', a: 'Yes — maintenance plans cover updates, security patches, monitoring and small improvements.' },
    ],
  },
  {
    ...
    short: 'Day-to-day care for your servers, networks, identity and Microsoft 365 — so your team just works.',
  ...
  },
  {
    ...
    icon: BrainCircuit,
    title: 'AI Solutions',
    short: 'Custom AI built on your data — intelligent search, document understanding, analytics and predictions.',
    ...
    stack: ['OpenAI', 'Claude', 'Llama', 'Python', 'LangChain', 'pgvector', 'Pinecone', 'FastAPI', 'AWS Bedrock'],
    outcomes: [
