...
export const services = [
  ...
  },
  {
    ...
    intro:
      'Most businesses have plenty of data, but it is spread across apps, spreadsheets, ERPs and databases that never talk to each other. We design and build the pipelines that bring it together, clean it, and deliver it to warehouses, dashboards and AI models, with monitoring so the numbers stay right.',
    offerings: [
